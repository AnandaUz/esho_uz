...
И я рад поделиться с вами гайдом <strong>"Трансформация без саботажа"</strong>, вы сможете почитать его пока я вам отвечаю
ссылка <a href="https://esho.uz/guide.pdf">guide.pdf</a>`;
    }
